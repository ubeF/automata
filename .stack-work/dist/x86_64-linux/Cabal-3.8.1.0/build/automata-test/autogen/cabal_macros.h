...
/* package automata-0.1.0.0 */
#ifndef VERSION_automata
#define VERSION_automata "0.1.0.0"
#endif /* VERSION_automata */
#ifndef MIN_VERSION_automata
#define MIN_VERSION_automata(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_automata */
/* package automata-0.1.0.0 */
#ifndef VERSION_automata
#define VERSION_automata "0.1.0.0"
#endif /* VERSION_automata */
...
#define CURRENT_COMPONENT_ID "automata-0.1.0.0-7dQT9cfjTniCwI5ICNaqUD-automata-test"
